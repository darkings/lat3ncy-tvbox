...
public class UserFragment extends BaseLazyFragment implements View.OnClickListener {
    ...
    protected void init() {
        ...
        homeHotVodAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if ((vod.id != null && !vod.id.isEmpty()) && (Hawk.get(HawkConfig.HOME_REC, HawkConfig.DEFAULT_HOME_REC) == 2) && HawkConfig.hotVodDelete) {
                    ...
                    ToastUtil.info(mContext, "已删除当前记录");
        ...
        tvHotList.setOnItemListener(new TvRecyclerView.OnItemListener() {
            ...
            public void onItemSelected(TvRecyclerView parent, View itemView, int position) {
                itemView.animate().scaleX(1.06f).scaleY(1.06f).setDuration(120).start();
            }
        ...
        sourceViewModel.actionResult.observe(this, new Observer<JSONObject>() {
            ...
            public void onChanged(JSONObject jsonObject) {
                ...
                if (!msg.isEmpty()) ToastUtil.info(getContext(), msg);
            }
        });
    }
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (hasFocus) {
                ...
                if (getActivity() instanceof HomeActivity) {
                    ((HomeActivity) getActivity()).showPonyoReview();
                }
            } else {
    ...
    public void onClick(View v) {
        ...
        if (getActivity() instanceof HomeActivity) {
            ((HomeActivity) getActivity()).showPonyoJump();
        }
