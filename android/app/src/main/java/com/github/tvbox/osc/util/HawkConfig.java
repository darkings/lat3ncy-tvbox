...
public class HawkConfig {
    ...
    public static final String PARSE_ENABLED = "parse_enabled"; // 勾选启用的解析器名，逗号分隔（空=全部）
    public static final String DEBUG_OPEN = "debug_open";
    public static final String DYNAMIC_COLOR = "dynamic_color"; // Android 12+ 壁纸动态取色
    public static final String REDUCE_MOTION = "reduce_motion"; // 减少动态效果
    ...
    public static final String HLS_CACHE = "hls_cache"; // 点播 HLS 缓存加速代理开关
    public static final String LIVE_HLS_PROXY = "live_hls_proxy"; // 直播HLS整片代理开关: 默认false(关闭防卡碟), 弱网大分片源可手动开
