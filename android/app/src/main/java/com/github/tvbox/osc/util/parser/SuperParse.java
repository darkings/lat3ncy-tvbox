    ...
    public static Object[] loadHtml(String flag, String url) {
        try {
            ...
            String html = "\n" +
                    ...
                    "iframeHtml=iframeHtml+\"<iframe class='jxframe' sandbox='allow-scripts allow-same-origin allow-forms' frameborder='0' allowfullscreen='true' webkitallowfullscreen='true' mozallowfullscreen='true' src=\"+URL+\"></iframe>\";\n" +
                    "}\n" +
                    "document.write(iframeHtml);\n" +
                    "setTimeout(function(){var fr=document.querySelectorAll('iframe.jxframe');for(var j=0;j<fr.length;j++){fr[j].src='about:blank';}},10000);\n" +
                    "</script>\n" +
                    "</body>\n" +
                    "</html>";
